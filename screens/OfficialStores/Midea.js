...
const brandId = 288;
const banners = [
  "https://tomato.com.mm/wp-content/uploads/2020/07/107024979_2630912173841547_901068446686646488_o-1024x450.jpg",
  "https://tomato.com.mm/wp-content/uploads/2020/07/WhatsApp-Image-2020-07-09-at-1.15.43-PM.jpeg",
];
const rowIds = {
  rowOne: 3084,
};

const Midea = ({ navigation, route }) => {
    ...
    <SafeAreaView>
      <ScrollView ref={scrollViewRef}>
        ...
        {brand.loading ? (
          ...
          brand.data.length > 0 && (
            <View>
              <ProductRow title="PROMOTIONS" products={brand.data} />
            </View>
          )
        )}
