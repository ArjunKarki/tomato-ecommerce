...
const brandIds = [3393, 3405]

const banners = [
  'https://tomato.com.mm/wp-content/uploads/2020/07/viber_image_2020-07-30_10-47-31-1024x389.jpg',
  'https://tomato.com.mm/wp-content/uploads/2020/07/viber_image_2020-07-30_11-16-55-1024x389.jpg',
  'https://tomato.com.mm/wp-content/uploads/2020/07/viber_image_2020-07-30_10-56-49-1024x389.jpg'
]

const AungKaBarTrading = ({ navigation, route }) => {
  ...
  const rowOne = useStoreBrand(rowbrandIds.rowOne)
  const rowTwo = useStoreBrand(rowbrandIds.rowTwo)
  const brands = useStoreMultiBrand(brandIds)
...
export default AungKaBarTrading
