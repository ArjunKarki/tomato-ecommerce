...
const banners = [
  "https://tomato.com.mm/wp-content/uploads/2020/07/0-02-06-75a8692f06981a43bc43a1642f80122536abb71b0117abb262fe53b7e92b894e_55f213ac-1-1024x441.jpg",
];

const PanasonicBeauty = ({ navigation, route }) => {
  ...
  const rowOne = useStoreTag(storeId, rowId.rowOne);
...
export default PanasonicBeauty;
