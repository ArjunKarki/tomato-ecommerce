...
const brandIds = [3437, 3436];
const banners = [
  "https://tomato.com.mm/wp-content/uploads/2020/07/viber_image_2020-07-29_09-53-53.jpg",
  "https://tomato.com.mm/wp-content/uploads/2020/07/98076006_606274579984300_5560484241604608000_n.jpg",
  "https://tomato.com.mm/wp-content/uploads/2020/07/viber_image_2020-07-28_14-31-01.jpg",
];

const rowIds = {
  rwoOne: [3068, 3433, 3558, 3561, 3560, 3559, 3429],
  rowTwo: [3586],
};

const MI = ({ navigation, route }) => {
  ...
  const rowOne = useStoreMultiTag(rowIds.rwoOne, storeId);
