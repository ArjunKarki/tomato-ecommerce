...
const tagIds = {
  rowOne: 588,
  rowTwo: [1577, 253, 1861, 2097],
};

const brandId = 2097;

const banners = [
  "https://tomato.com.mm/wp-content/uploads/2020/06/ovt_brand_banner_-CN7_-KV_PM2000x878px-1024x450.jpg",
  "https://tomato.com.mm/wp-content/uploads/2020/06/ovt_brand_banner_-Immunity-KV_MM2000x878px-1024x450.jpg",
];

const Ovaltine = ({ navigation, route }) => {
